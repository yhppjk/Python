...
#    Jan 15, 2022 02:40:53 PM CET  platform: Windows NT
...
class MainWindow:
    def __init__(self, top=None):
        ...
        self.FrameEtat.place(relx=0.0, rely=0.934, relheight=0.053
                , relwidth=0.831)
        ...
        self.FrameEMes.place(relx=0.008, rely=0.021, relheight=0.86
                , relwidth=0.38)
        ...
        self.BtnReset.bind('<Button-1>',lambda e:MainWindow_support.GUIBtnReset(e))
        ...
        self.MesureP.place(relx=0.425, rely=0.021, relheight=0.86
                , relwidth=0.539)
        ...
        self.PBVitesse.place(relx=0.254, rely=0.173, relwidth=0.141
                , relheight=0.0, height=22, bordermode='ignore')

        self.PBTemperature = ttk.Progressbar(self.MesureP)
        self.PBTemperature.place(relx=0.254, rely=0.272, relwidth=0.141
                , relheight=0.0, height=22, bordermode='ignore')

        self.PBLuminosite = ttk.Progressbar(self.MesureP)
        self.PBLuminosite.place(relx=0.254, rely=0.37, relwidth=0.141
                , relheight=0.0, height=22, bordermode='ignore')

        self.PBHumidite = ttk.Progressbar(self.MesureP)
        self.PBHumidite.place(relx=0.254, rely=0.469, relwidth=0.141
                , relheight=0.0, height=22, bordermode='ignore')

        self.PBPluviometrie = ttk.Progressbar(self.MesureP)
        self.PBPluviometrie.place(relx=0.254, rely=0.568, relwidth=0.141
                , relheight=0.0, height=22, bordermode='ignore')

        self.PPeakVitesse = tk.Canvas(self.MesureP)
        self.PPeakVitesse.place(relx=0.437, rely=0.074, relheight=0.501
                , relwidth=0.539, bordermode='ignore')
        self.PPeakVitesse.configure(background="#ffffff")
        self.PPeakVitesse.configure(borderwidth="2")
        self.PPeakVitesse.configure(cursor="fleur")
        ...
        self.Label1 = tk.Label(self.MesureP)
        self.Label1.place(relx=0.239, rely=0.148, height=18, width=11
                , bordermode='ignore')
        self.Label1.configure(activebackground="#f9f9f9")
        self.Label1.configure(activeforeground="black")
        self.Label1.configure(background="#d9d9d9")
        self.Label1.configure(disabledforeground="#a3a3a3")
        self.Label1.configure(font="-family {Segoe UI} -size 7")
        self.Label1.configure(foreground="#000000")
        self.Label1.configure(highlightbackground="#d9d9d9")
        self.Label1.configure(highlightcolor="black")
        self.Label1.configure(text='''0''')

        self.Label1_1 = tk.Label(self.MesureP)
        self.Label1_1.place(relx=0.239, rely=0.247, height=18, width=11
                , bordermode='ignore')
        self.Label1_1.configure(activebackground="#f9f9f9")
        self.Label1_1.configure(activeforeground="black")
        self.Label1_1.configure(background="#d9d9d9")
        self.Label1_1.configure(disabledforeground="#a3a3a3")
        self.Label1_1.configure(font="-family {Segoe UI} -size 7")
        self.Label1_1.configure(foreground="#000000")
        self.Label1_1.configure(highlightbackground="#d9d9d9")
        self.Label1_1.configure(highlightcolor="black")
        self.Label1_1.configure(text='''0''')

        self.Label1_2 = tk.Label(self.MesureP)
        self.Label1_2.place(relx=0.239, rely=0.346, height=18, width=11
                , bordermode='ignore')
        self.Label1_2.configure(activebackground="#f9f9f9")
        self.Label1_2.configure(activeforeground="black")
        self.Label1_2.configure(background="#d9d9d9")
        self.Label1_2.configure(disabledforeground="#a3a3a3")
        self.Label1_2.configure(font="-family {Segoe UI} -size 7")
        self.Label1_2.configure(foreground="#000000")
        self.Label1_2.configure(highlightbackground="#d9d9d9")
        self.Label1_2.configure(highlightcolor="black")
        self.Label1_2.configure(text='''0''')

        self.Label1_3 = tk.Label(self.MesureP)
        self.Label1_3.place(relx=0.239, rely=0.444, height=18, width=11
                , bordermode='ignore')
        self.Label1_3.configure(activebackground="#f9f9f9")
        self.Label1_3.configure(activeforeground="black")
        self.Label1_3.configure(background="#d9d9d9")
        self.Label1_3.configure(disabledforeground="#a3a3a3")
        self.Label1_3.configure(font="-family {Segoe UI} -size 7")
        self.Label1_3.configure(foreground="#000000")
        self.Label1_3.configure(highlightbackground="#d9d9d9")
        self.Label1_3.configure(highlightcolor="black")
        self.Label1_3.configure(text='''0''')

        self.Label1_4 = tk.Label(self.MesureP)
        self.Label1_4.place(relx=0.239, rely=0.543, height=18, width=11
                , bordermode='ignore')
        ...
        self.Label1_4.configure(font="-family {Segoe UI} -size 7")
        self.Label1_4.configure(foreground="#000000")
        self.Label1_4.configure(highlightbackground="#d9d9d9")
        self.Label1_4.configure(highlightcolor="black")
        self.Label1_4.configure(text='''0''')

        self.Label1_5 = tk.Label(self.MesureP)
        self.Label1_5.place(relx=0.394, rely=0.148, height=21, width=14
                , bordermode='ignore')
        ...
        self.Label1_5.configure(font="-family {Segoe UI} -size 7")
        ...
        self.Label1_5.configure(text='''30''')

        self.Label1_5_1 = tk.Label(self.MesureP)
        self.Label1_5_1.place(relx=0.394, rely=0.247, height=21, width=14
                , bordermode='ignore')
        self.Label1_5_1.configure(activebackground="#f9f9f9")
        self.Label1_5_1.configure(activeforeground="black")
        self.Label1_5_1.configure(background="#d9d9d9")
        self.Label1_5_1.configure(disabledforeground="#a3a3a3")
        self.Label1_5_1.configure(font="-family {Segoe UI} -size 7")
        ...
        self.Label1_5_1.configure(text='''50''')

        self.Label1_5_2 = tk.Label(self.MesureP)
        self.Label1_5_2.place(relx=0.394, rely=0.346, height=21, width=24
                , bordermode='ignore')
        self.Label1_5_2.configure(activebackground="#f9f9f9")
        self.Label1_5_2.configure(activeforeground="black")
        self.Label1_5_2.configure(background="#d9d9d9")
        self.Label1_5_2.configure(disabledforeground="#a3a3a3")
        self.Label1_5_2.configure(font="-family {Segoe UI} -size 7")
        self.Label1_5_2.configure(foreground="#000000")
        self.Label1_5_2.configure(highlightbackground="#d9d9d9")
        self.Label1_5_2.configure(highlightcolor="black")
        self.Label1_5_2.configure(text='''150''')

        self.Label1_5_3 = tk.Label(self.MesureP)
        self.Label1_5_3.place(relx=0.394, rely=0.444, height=21, width=24
                , bordermode='ignore')
        self.Label1_5_3.configure(activebackground="#f9f9f9")
        self.Label1_5_3.configure(activeforeground="black")
        self.Label1_5_3.configure(background="#d9d9d9")
        self.Label1_5_3.configure(disabledforeground="#a3a3a3")
        self.Label1_5_3.configure(font="-family {Segoe UI} -size 7")
        self.Label1_5_3.configure(foreground="#000000")
        self.Label1_5_3.configure(highlightbackground="#d9d9d9")
        self.Label1_5_3.configure(highlightcolor="black")
        self.Label1_5_3.configure(text='''100''')

        self.Label1_5_4 = tk.Label(self.MesureP)
        self.Label1_5_4.place(relx=0.394, rely=0.543, height=21, width=14
                , bordermode='ignore')
        self.Label1_5_4.configure(activebackground="#f9f9f9")
        self.Label1_5_4.configure(activeforeground="black")
        self.Label1_5_4.configure(background="#d9d9d9")
        self.Label1_5_4.configure(disabledforeground="#a3a3a3")
        self.Label1_5_4.configure(font="-family {Segoe UI} -size 7")
        self.Label1_5_4.configure(foreground="#000000")
        self.Label1_5_4.configure(highlightbackground="#d9d9d9")
        self.Label1_5_4.configure(highlightcolor="black")
        self.Label1_5_4.configure(text='''10''')

        self.PListeVitesse = tk.Label(self.MesureP)
        self.PListeVitesse.place(relx=0.437, rely=0.593, height=131, width=384
                , bordermode='ignore')
        self.PListeVitesse.configure(anchor='nw')
        self.PListeVitesse.configure(background="#d9d9d9")
        self.PListeVitesse.configure(cursor="fleur")
        self.PListeVitesse.configure(disabledforeground="#a3a3a3")
        self.PListeVitesse.configure(font="-family {Segoe UI} -size 9")
        self.PListeVitesse.configure(foreground="#000000")
        self.PListeVitesse.configure(relief="sunken")
