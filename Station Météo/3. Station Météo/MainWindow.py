...
#    Jan 05, 2022 08:56:51 AM CET  platform: Windows NT
...
class MainWindow:
    def __init__(self, top=None):
        ...
        self.DirectVent.configure(text='''Girouette''')
        self.DirectVent.configure(width=80)

        self.EDirectVent = tk.Label(self.MesureP)
        self.EDirectVent.place(relx=0.141, rely=0.074, height=21, width=54
                , bordermode='ignore')
        self.EDirectVent.configure(activebackground="#f9f9f9")
        self.EDirectVent.configure(activeforeground="black")
        self.EDirectVent.configure(anchor='e')
        self.EDirectVent.configure(background="#d9d9d9")
        self.EDirectVent.configure(disabledforeground="#a3a3a3")
        self.EDirectVent.configure(font="-family {Segoe UI} -size 9 -weight bold")
        self.EDirectVent.configure(foreground="#000000")
        self.EDirectVent.configure(highlightbackground="#d9d9d9")
        self.EDirectVent.configure(highlightcolor="black")
        self.EDirectVent.configure(relief="sunken")
        self.EDirectVent.configure(text='''9,999''')
        ...
        self.EVVent = tk.Label(self.MesureP)
        self.EVVent.place(relx=0.141, rely=0.173, height=21, width=54
                , bordermode='ignore')
        self.EVVent.configure(activebackground="#f9f9f9")
        self.EVVent.configure(activeforeground="black")
        self.EVVent.configure(anchor='e')
        self.EVVent.configure(background="#d9d9d9")
        self.EVVent.configure(disabledforeground="#a3a3a3")
        self.EVVent.configure(font="-family {Segoe UI} -size 9 -weight bold")
        self.EVVent.configure(foreground="#000000")
        self.EVVent.configure(highlightbackground="#d9d9d9")
        self.EVVent.configure(highlightcolor="black")
        self.EVVent.configure(relief="sunken")
        self.EVVent.configure(text='''0''')
        ...
        self.ETemp = tk.Label(self.MesureP)
        self.ETemp.place(relx=0.141, rely=0.272, height=21, width=54
                , bordermode='ignore')
        self.ETemp.configure(activebackground="#f9f9f9")
        self.ETemp.configure(activeforeground="black")
        self.ETemp.configure(anchor='e')
        self.ETemp.configure(background="#d9d9d9")
        self.ETemp.configure(disabledforeground="#a3a3a3")
        self.ETemp.configure(font="-family {Segoe UI} -size 9 -weight bold")
        self.ETemp.configure(foreground="#000000")
        self.ETemp.configure(highlightbackground="#d9d9d9")
        self.ETemp.configure(highlightcolor="black")
        self.ETemp.configure(relief="sunken")
        self.ETemp.configure(text='''9,999''')
        ...
        self.ELumi = tk.Label(self.MesureP)
        self.ELumi.place(relx=0.141, rely=0.37, height=21, width=54
                , bordermode='ignore')
        self.ELumi.configure(activebackground="#f9f9f9")
        self.ELumi.configure(activeforeground="black")
        self.ELumi.configure(anchor='e')
        self.ELumi.configure(background="#d9d9d9")
        self.ELumi.configure(disabledforeground="#a3a3a3")
        self.ELumi.configure(font="-family {Segoe UI} -size 9 -weight bold")
        self.ELumi.configure(foreground="#000000")
        self.ELumi.configure(highlightbackground="#d9d9d9")
        self.ELumi.configure(highlightcolor="black")
        self.ELumi.configure(relief="sunken")
        self.ELumi.configure(text='''9,999''')
        ...
        self.EHumi = tk.Label(self.MesureP)
        self.EHumi.place(relx=0.141, rely=0.469, height=21, width=54
                , bordermode='ignore')
        self.EHumi.configure(activebackground="#f9f9f9")
        self.EHumi.configure(activeforeground="black")
        self.EHumi.configure(anchor='e')
        self.EHumi.configure(background="#d9d9d9")
        self.EHumi.configure(disabledforeground="#a3a3a3")
        self.EHumi.configure(font="-family {Segoe UI} -size 9 -weight bold")
        self.EHumi.configure(foreground="#000000")
        self.EHumi.configure(highlightbackground="#d9d9d9")
        self.EHumi.configure(highlightcolor="black")
        self.EHumi.configure(relief="sunken")
        self.EHumi.configure(text='''999''')
        ...
        self.EPluvi = tk.Label(self.MesureP)
        self.EPluvi.place(relx=0.141, rely=0.568, height=21, width=54
                , bordermode='ignore')
        self.EPluvi.configure(activebackground="#f9f9f9")
        self.EPluvi.configure(activeforeground="black")
        self.EPluvi.configure(anchor='e')
        self.EPluvi.configure(background="#d9d9d9")
        self.EPluvi.configure(disabledforeground="#a3a3a3")
        self.EPluvi.configure(font="-family {Segoe UI} -size 9 -weight bold")
        self.EPluvi.configure(foreground="#000000")
        self.EPluvi.configure(highlightbackground="#d9d9d9")
        self.EPluvi.configure(highlightcolor="black")
        self.EPluvi.configure(relief="sunken")
        self.EPluvi.configure(text='''0''')
        ...
        self.ENoStation = tk.Label(self.MesureP)
        self.ENoStation.place(relx=0.141, rely=0.667, height=21, width=54
                , bordermode='ignore')
        self.ENoStation.configure(activebackground="#f9f9f9")
        self.ENoStation.configure(activeforeground="black")
        self.ENoStation.configure(anchor='e')
        self.ENoStation.configure(background="#d9d9d9")
        self.ENoStation.configure(disabledforeground="#a3a3a3")
        self.ENoStation.configure(font="-family {Segoe UI} -size 9 -weight bold")
        self.ENoStation.configure(foreground="#000000")
        self.ENoStation.configure(highlightbackground="#d9d9d9")
        self.ENoStation.configure(highlightcolor="black")
        self.ENoStation.configure(relief="sunken")
        self.ENoStation.configure(text='''0''')
        ...
        self.BTemp.place(relx=0.254, rely=0.272, relwidth=0.141, relheight=0.0
                , height=22, bordermode='ignore')
        self.BTemp.configure(cursor="fleur")
