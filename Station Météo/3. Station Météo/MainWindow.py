...
class MainWindow:
    def __init__(self, top=None):
        ...
        self.TextPeak.place(relx=0.423, rely=0.593, relheight=0.38
                , relwidth=0.541, bordermode='ignore')
        self.TextPeak.configure(background="#cacaca")
        self.TextPeak.configure(font="-family {Segoe UI} -size 9 -weight bold")
        self.TextPeak.configure(foreground="black")
        self.TextPeak.configure(highlightbackground="#d9d9d9")
        self.TextPeak.configure(highlightcolor="black")
        self.TextPeak.configure(insertbackground="black")
        self.TextPeak.configure(selectbackground="blue")
        self.TextPeak.configure(selectforeground="white")
        self.TextPeak.configure(wrap="word")
