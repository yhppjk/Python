...
proc vTclWindow.top44 {base} {
    ...
    wm geometry $top 1317x471+52+66
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    ttk::progressbar $site_3_0.tPr45 \
        -length 100 
    vTcl:DefineAlias "$site_3_0.tPr45" "PBVitesse" vTcl:WidgetProc "MainWindow" 1
    ttk::progressbar $site_3_0.tPr46 \
        -length 100 
    vTcl:DefineAlias "$site_3_0.tPr46" "PBTemperature" vTcl:WidgetProc "MainWindow" 1
    ttk::progressbar $site_3_0.tPr47 \
        -length 100 
    vTcl:DefineAlias "$site_3_0.tPr47" "PBLuminosite" vTcl:WidgetProc "MainWindow" 1
    ttk::progressbar $site_3_0.tPr48 \
        -length 100 
    vTcl:DefineAlias "$site_3_0.tPr48" "PBHumidite" vTcl:WidgetProc "MainWindow" 1
    ttk::progressbar $site_3_0.tPr49 \
        -length 100 
    vTcl:DefineAlias "$site_3_0.tPr49" "PBPluviometrie" vTcl:WidgetProc "MainWindow" 1
    canvas $site_3_0.can51 \
        -background #ffffff -borderwidth 2 -closeenough 1.0 -height 203 \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -insertbackground black -selectbackground blue \
        -selectforeground white -width 383 
    vTcl:DefineAlias "$site_3_0.can51" "PPeakVitesse" vTcl:WidgetProc "MainWindow" 1
    ...
    label $site_3_0.lab46 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -text 0 
    vTcl:DefineAlias "$site_3_0.lab46" "Label1_1" vTcl:WidgetProc "MainWindow" 1
    label $site_3_0.lab47 \
        -activebackground #f9f9f9 -activeforeground black \
        -background $vTcl(actual_gui_bg) -disabledforeground #a3a3a3 \
        -font {-family {Segoe UI} -size 7 -weight normal -slant roman -underline 0 -overstrike 0} \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -text 0 
    vTcl:DefineAlias "$site_3_0.lab47" "Label1_2" vTcl:WidgetProc "MainWindow" 1
    label $site_3_0.lab48 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -text 0 
    vTcl:DefineAlias "$site_3_0.lab48" "Label1_3" vTcl:WidgetProc "MainWindow" 1
    label $site_3_0.lab49 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -text 0 
    vTcl:DefineAlias "$site_3_0.lab49" "Label1_4" vTcl:WidgetProc "MainWindow" 1
    label $site_3_0.lab51 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -text 30 
    vTcl:DefineAlias "$site_3_0.lab51" "Label1_5" vTcl:WidgetProc "MainWindow" 1
    label $site_3_0.lab52 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -text 50 
    vTcl:DefineAlias "$site_3_0.lab52" "Label1_5_1" vTcl:WidgetProc "MainWindow" 1
    label $site_3_0.lab53 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -text 150 
    vTcl:DefineAlias "$site_3_0.lab53" "Label1_5_2" vTcl:WidgetProc "MainWindow" 1
    label $site_3_0.lab54 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -text 100 
    vTcl:DefineAlias "$site_3_0.lab54" "Label1_5_3" vTcl:WidgetProc "MainWindow" 1
    label $site_3_0.lab55 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -text 10 
    vTcl:DefineAlias "$site_3_0.lab55" "Label1_5_4" vTcl:WidgetProc "MainWindow" 1
    label $site_3_0.lab50 \
        -anchor nw -background $vTcl(actual_gui_bg) \
        -disabledforeground #a3a3a3 -font $vTcl(actual_gui_font_dft_desc) \
        -foreground $vTcl(actual_gui_fg) -relief sunken 
    vTcl:DefineAlias "$site_3_0.lab50" "PListeVitesse" vTcl:WidgetProc "MainWindow" 1
    place $site_3_0.mes77 \
        -in $site_3_0 -x 20 -y 30 -width 80 -height 22 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab78 \
    ...
    place $site_3_0.can51 \
        -in $site_3_0 -x 310 -y 30 -width 383 -relwidth 0 -height 203 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab45 \
        -in $site_3_0 -x 170 -y 60 -anchor nw -bordermode ignore 
    place $site_3_0.lab46 \
        -in $site_3_0 -x 170 -y 100 -width 11 -height 18 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab47 \
        -in $site_3_0 -x 170 -y 140 -width 11 -height 18 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab48 \
        -in $site_3_0 -x 170 -y 180 -width 11 -height 18 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab49 \
        -in $site_3_0 -x 170 -y 220 -width 11 -height 18 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab51 \
        -in $site_3_0 -x 280 -y 60 -width 14 -relwidth 0 -height 21 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab52 \
        -in $site_3_0 -x 280 -y 100 -width 14 -height 21 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab53 \
        -in $site_3_0 -x 280 -y 140 -width 24 -relwidth 0 -height 21 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab54 \
        -in $site_3_0 -x 280 -y 180 -width 24 -relwidth 0 -height 21 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab55 \
        -in $site_3_0 -x 280 -y 220 -width 14 -height 21 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab50 \
        -in $site_3_0 -x 310 -y 240 -width 384 -relwidth 0 -height 131 \
        -relheight 0 -anchor nw -bordermode ignore 
    ###################
    # SETTING GEOMETRY
    ###################
    ...
    place $top.lab66 \
        ...
        -anchor nw -bordermode ignore 
    place $top.lab46 \
        -in $top -x 560 -y 10 -width 710 -relwidth 0 -height 405 -relheight 0 \
        -anchor nw -bordermode ignore 
