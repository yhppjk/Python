...
#  Jan 03, 2022 05:20:41 PM CET  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top44 {base} {
    ...
    wm geometry $top 1043x467+0+129
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    label $site_3_0.lab83 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -relief sunken -text {9,999 } 
    vTcl:DefineAlias "$site_3_0.lab83" "EThermometre_1" vTcl:WidgetProc "MainWindow" 1
    message $site_3_0.mes84 \
        -anchor e -background $vTcl(actual_gui_bg) \
        -font {-family {Segoe UI} -size 9} -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
    ...
    ###################
    place $top.fra45 \
        -in $top -x 0 -y 440 -width 515 -relwidth 0 -height 25 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.lab66 \
        -in $top -x 10 -y 10 -width 500 -relwidth 0 -height 405 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.lab46 \
        -in $top -x 540 -y 10 -width 500 -height 405 -anchor nw \
        -bordermode ignore 
